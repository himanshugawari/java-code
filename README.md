...
Lets now look at adding a few hours to a date object. All date manipulation to date needs to be done by adding milliseconds to the date. For example, if we want to add 6 hour, we convert 6 hours into millseconds. 6 hours = 6 _ 60 _ 60 \* 1000 milliseconds. Below examples shows specific code.
...
Similarly _? is reluctant match for the greedy _
